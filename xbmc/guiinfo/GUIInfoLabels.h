...
#define LISTITEM_ADDON_NAME         (LISTITEM_START + 161)
#define LISTITEM_ADDON_VERSION      (LISTITEM_START + 162)
#define LISTITEM_ADDON_CREATOR      (LISTITEM_START + 163)
#define LISTITEM_ADDON_SUMMARY      (LISTITEM_START + 164)
#define LISTITEM_ADDON_DESCRIPTION  (LISTITEM_START + 165)
#define LISTITEM_ADDON_DISCLAIMER   (LISTITEM_START + 166)
#define LISTITEM_ADDON_BROKEN       (LISTITEM_START + 167)
#define LISTITEM_ADDON_TYPE         (LISTITEM_START + 168)
#define LISTITEM_ADDON_INSTALL_DATE (LISTITEM_START + 169)
#define LISTITEM_ADDON_LAST_UPDATED (LISTITEM_START + 170)
#define LISTITEM_ADDON_LAST_USED    (LISTITEM_START + 171)
